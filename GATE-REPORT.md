...
| 2_static | D1 | block,deterministic,★pflicht | PASS | kein High/Medium (10 Low, beraten) |
...
- **G3** — WARN — 14 Query-in-Loop-Verdacht (N+1)
    ...
    - `ralph/stop_hook.py:40` [n+1-query] ******
    - `feedback/feedback.py:167` [n+1-query] *****
    - `feedback/feedback.py:171` [n+1-query] *****
...
- **H2** — WARN — 5 Funktion(en) ueber Komplexitaet 12
    ...
    - `gates/runner.py:235` [complexity] _write_report() = 19
    - `gates/verdict.py:37` [complexity] load_pflichtenheft() = 16
    - `feedback/feedback.py:179` [complexity] main() = 13
