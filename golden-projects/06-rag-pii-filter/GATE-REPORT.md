# GATE-REPORT — target=`golden-projects/06-rag-pii-filter` — 2026-06-08T22:32:15Z

## Zusammenfassung
- **Ergebnis:** GRUEN
- **Block-Gates rot:** 0
- **Warn-Gates:** 0
- **Gates ohne Check (offen, SKIP):** 31
...
| 2_static | B3 | block,deterministic | PASS | Build/Compile sauber (3 .py) |
...
| 4_sovereignty_dsgvo | E5 | block,deterministic | PASS | alle 2 Soll-Artefakte vorhanden, gefuellt, platzhalterfrei, EU |
