# GATE-REPORT — target=`.` — 2026-06-11T06:28:06Z
...
| 3_tests | C1 | block,deterministic,★pflicht | PASS | Tests grün (230 Tests in gates/checks/tests) |
| 3_tests | C2 | block,deterministic,★pflicht | PASS | Coverage 87% >= 70% |
