# GATE-REPORT — target=`examples/pilot-app` — 2026-06-08T11:38:53Z

## Zusammenfassung
- **Ergebnis:** GRUEN
- **Block-Gates rot:** 0
- **Warn-Gates:** 0
- **Gates ohne Check (offen, SKIP):** 30
...
| 3_tests | C1 | block,deterministic | PASS | Tests grün (9 Tests in tests) |
