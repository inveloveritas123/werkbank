...
> **BMAD als Methode, Ralph/kiln als Autonomie, WERKBANK als DSGVO-/KOLONIE-Governance.**
...
2. **Souveränität verdrahten:** `settings.yaml` mit echten EU-Routing-Werten füllen
   (Bedrock Frankfurt + Requesty EU). Gate **E1 (EU-Routing)** als erstes scharf schalten.
...
Gemessen an „Plan, um KOLONIE auf BMAD-Basis aufzubohren": ~75 %. Der einzige Weg, das zu
